import { Graphics, Renderer, Ticker } from 'pixi.js';
...
export function create(renderer:Renderer) {
    // create the viewport
...
function border(viewport:Viewport) {
    ...
    line.lineStyle(10, 0x3333FF).drawRect(0, 0, viewport.worldWidth, viewport.worldHeight)
}
